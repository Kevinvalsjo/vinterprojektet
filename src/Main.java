...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Ingredienser ingredienser = new Ingredienser();
                ...
                switch (svar1) {
                    ...
                    case 1 -> {
                        ...
                        switch (svar1) {
                            ...
                            case 1 -> {
                                System.out.println("Den här produkten har " + salt.kalo() + " kalorier");

                            }
                            case 2 -> {
                                System.out.println("Den här produkten kommer ifrån " + salt.plats());
                            }
                                        }
                              }
